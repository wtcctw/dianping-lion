...
public class InitializeConfig implements BeanFactoryPostProcessor,
	...
	public void postProcessBeanFactory(
			ConfigurableListableBeanFactory beanFactoryToProcess) throws BeansException {
		try {
			init();
		...
		try {
			...
			for(String key:keyList){
				this.pts.remove(key);
				logger.warn("Environment :" +environment +"! Ignore Key Config In ApplicationContext! Key: "+ (String)key);
			}
